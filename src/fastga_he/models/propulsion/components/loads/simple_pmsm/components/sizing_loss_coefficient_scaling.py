...
class SizingMotorLossCoefficientScaling(om.ExplicitComponent):
    ...
    def compute(self, inputs, outputs, discrete_inputs=None, discrete_outputs=None):
        ...
        outputs["data:propulsion:he_power_train:simple_PMSM:" + motor_id + ":scaling:alpha"] = (
            alpha_scaling
        )
        outputs["data:propulsion:he_power_train:simple_PMSM:" + motor_id + ":scaling:beta"] = (
            beta_scaling
        )
        outputs["data:propulsion:he_power_train:simple_PMSM:" + motor_id + ":scaling:gamma"] = (
            gamma_scaling
        )
