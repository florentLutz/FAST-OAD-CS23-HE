...
SUBMODEL_CONSTRAINTS_PMSM_TORQUE = "submodel.propulsion.constraints.sm_pmsm.torque"
SUBMODEL_CONSTRAINTS_PMSM_RPM = "submodel.propulsion.constraints.sm_pmsm.rpm"
SUBMODEL_CONSTRAINTS_PMSM_VOLTAGE = "submodel.propulsion.constraints.sm_pmsm.voltage"
