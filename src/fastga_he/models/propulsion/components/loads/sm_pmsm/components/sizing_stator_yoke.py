...
class SizingStatorYokeHeight(om.ExplicitComponent):
    ...
    def setup(self):
        ...
        self.add_input(
            name="data:propulsion:he_power_train:SM_PMSM:" + pmsm_id + ":yoke_flux_density",
            val=np.nan,
            units="T",
    ...
    def compute(self, inputs, outputs, discrete_inputs=None, discrete_outputs=None):
        ...
        outputs["data:propulsion:he_power_train:SM_PMSM:" + pmsm_id + ":stator_yoke_height"] = (
    ...
    def compute_partials(self, inputs, partials, discrete_inputs=None):
        ...
        partials[
            "data:propulsion:he_power_train:SM_PMSM:" + pmsm_id + ":stator_yoke_height",
            "data:propulsion:he_power_train:SM_PMSM:" + pmsm_id + ":yoke_flux_density",
