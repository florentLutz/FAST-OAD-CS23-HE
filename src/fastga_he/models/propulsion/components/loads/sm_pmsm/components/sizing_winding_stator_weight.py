...
class SizingStatorWindingWeight(om.ExplicitComponent):
    ...
    def compute(self, inputs, outputs, discrete_inputs=None, discrete_outputs=None):
        ...
        winding_volume = conductor_cable_length * slot_section_area * num_conductor_slot
    ...
    def compute_partials(self, inputs, partials, discrete_inputs=None):
        ...
        partials[
            ...
            "data:propulsion:he_power_train:SM_PMSM:" + motor_id + ":conductor_cable_length",
        ] = num_conductor_slot * slot_section_area * material_mix_density

        partials[
            "data:propulsion:he_power_train:SM_PMSM:" + motor_id + ":stator_winding_mass",
            "data:propulsion:he_power_train:SM_PMSM:" + motor_id + ":slot_section_area",
        ] = conductor_cable_length * num_conductor_slot * material_mix_density

        partials[
            "data:propulsion:he_power_train:SM_PMSM:" + motor_id + ":stator_winding_mass",
            "data:propulsion:he_power_train:SM_PMSM:" + motor_id + ":conductor_slot_number",
        ] = conductor_cable_length * slot_section_area * material_mix_density
