...
class SizingPMSMCGX(om.ExplicitComponent):
    ...
    def setup(self):
        ...
        if position == "on_the_wing":
            self.add_input(
                name="data:propulsion:he_power_train:SM_PMSM:" + pmsm_id + ":from_LE",
                val=np.nan,
                units="m",
            ...
            self.add_input(
                name="data:propulsion:he_power_train:SM_PMSM:" + pmsm_id + ":front_length_ratio",
                val=np.nan,
        ...
        self.add_output(
            "data:propulsion:he_power_train:SM_PMSM:" + pmsm_id + ":CG:x",
            units="m",
            val=2.5,
    ...
    def compute(self, inputs, outputs, discrete_inputs=None, discrete_outputs=None):
        ...
        if position == "on_the_wing":
            distance_from_le = inputs[
                "data:propulsion:he_power_train:SM_PMSM:" + pmsm_id + ":from_LE"
            ]
            motor_length = inputs[
            ...
            outputs["data:propulsion:he_power_train:SM_PMSM:" + pmsm_id + ":CG:x"] = (
            ...
            lav_ratio = inputs[
                "data:propulsion:he_power_train:SM_PMSM:" + pmsm_id + ":front_length_ratio"
            ]

            outputs["data:propulsion:he_power_train:SM_PMSM:" + pmsm_id + ":CG:x"] = lav * lav_ratio
    ...
    def compute_partials(self, inputs, partials, discrete_inputs=None):
        ...
        if position == "on_the_wing":
            ...
            ] = inputs["data:propulsion:he_power_train:SM_PMSM:" + pmsm_id + ":front_length_ratio"]
