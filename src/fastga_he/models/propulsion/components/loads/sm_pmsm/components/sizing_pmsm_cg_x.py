...
class SizingPMSMCGX(om.ExplicitComponent):
    ...
    def compute(self, inputs, outputs, discrete_inputs=None, discrete_outputs=None):
        ...
        if position == "on_the_wing":
            ...
            outputs["data:propulsion:he_power_train:SM_PMSM:" + motor_id + ":CG:x"] = (
            ...
            lav_ratio = inputs[
                "data:propulsion:he_power_train:SM_PMSM:" + motor_id + ":front_length_ratio"
            ]
    ...
    def compute_partials(self, inputs, partials, discrete_inputs=None):
        ...
        if position == "on_the_wing":
            ...
            ] = inputs["data:propulsion:he_power_train:SM_PMSM:" + motor_id + ":front_length_ratio"]
