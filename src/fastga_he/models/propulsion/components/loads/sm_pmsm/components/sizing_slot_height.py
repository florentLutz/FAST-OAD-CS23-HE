...
class SizingSlotHeight(om.ExplicitComponent):
    ...
    def setup(self):
        ...
        self.add_input(
            name="data:propulsion:he_power_train:SM_PMSM:" + pmsm_id + ":current_density_ac_max",
            val=np.nan,
            units="A/m**2",
        )
        self.add_input(
            name="data:propulsion:he_power_train:SM_PMSM:" + pmsm_id + ":winding_factor",
            val=np.nan,
        )
        self.add_input(
    ...
    def compute(self, inputs, outputs, discrete_inputs=None, discrete_outputs=None):
        ...
        k_w = inputs["data:propulsion:he_power_train:SM_PMSM:" + pmsm_id + ":winding_factor"]
        b_m = inputs["data:propulsion:he_power_train:SM_PMSM:" + pmsm_id + ":airgap_flux_density"]
        j_rms = inputs[
            "data:propulsion:he_power_train:SM_PMSM:" + pmsm_id + ":current_density_ac_max"
        ]
        k_sc = inputs[
        ...
        r_tooth = inputs["data:propulsion:he_power_train:SM_PMSM:" + pmsm_id + ":tooth_ratio"]

        outputs["data:propulsion:he_power_train:SM_PMSM:" + pmsm_id + ":slot_height"] = (
    ...
    def compute_partials(self, inputs, partials, discrete_inputs=None):
        ...
        partials[
            "data:propulsion:he_power_train:SM_PMSM:" + pmsm_id + ":slot_height",
            "data:propulsion:he_power_train:SM_PMSM:" + pmsm_id + ":winding_factor",
