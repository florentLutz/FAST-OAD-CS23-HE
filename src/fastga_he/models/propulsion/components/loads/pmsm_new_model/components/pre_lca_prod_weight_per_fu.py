...
class PreLCAMotorProdWeightPerFU(om.ExplicitComponent):
    ...
    def setup(self):
        ...
        self.add_input(
            name="data:propulsion:he_power_train:ACPMSM:" + pmsm_id + ":lifespan",
            units="yr",
            val=15.0,
        ...
        self.add_output(
            name="data:propulsion:he_power_train:ACPMSM:" + pmsm_id + ":mass_per_fu",
            units="kg",
            val=1e-6,
        ...
        self.declare_partials(
            ...
            wrt=[
                ...
                "data:propulsion:he_power_train:ACPMSM:" + pmsm_id + ":lifespan",
            ],
            method="fd",
        )
    ...
    def compute(self, inputs, outputs, discrete_inputs=None, discrete_outputs=None):
        ...
        outputs["data:propulsion:he_power_train:ACPMSM:" + pmsm_id + ":mass_per_fu"] = (
            ...
            * np.ceil(
                ...
                / inputs["data:propulsion:he_power_train:ACPMSM:" + pmsm_id + ":lifespan"]
            )
        )
    ...
    def compute_partials(self, inputs, partials, discrete_inputs=None):
        ...
        partials[
            "data:propulsion:he_power_train:ACPMSM:" + pmsm_id + ":mass_per_fu",
            "data:propulsion:he_power_train:ACPMSM:" + pmsm_id + ":mass",
        ...
        partials[
            "data:propulsion:he_power_train:ACPMSM:" + pmsm_id + ":mass_per_fu",
            "data:environmental_impact:aircraft_per_fu",
        ] = inputs["data:propulsion:he_power_train:ACPMSM:" + pmsm_id + ":mass"] * np.ceil(
            inputs["data:TLAR:aircraft_lifespan"]
            / inputs["data:propulsion:he_power_train:ACPMSM:" + pmsm_id + ":lifespan"]
        )
