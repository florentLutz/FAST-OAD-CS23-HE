...
from fastga_he.models.propulsion.components.loads.pmsm.pmsm_new_model.unused_modules.perf_losses import (
    PerformancesLosses,
)
from fastga_he.models.propulsion.components.loads.pmsm.pmsm_new_model.unused_modules.perf_efficiency import (
