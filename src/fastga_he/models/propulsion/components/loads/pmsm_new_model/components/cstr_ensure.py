...
class ConstraintsTorqueEnsure(om.ExplicitComponent):
    ...
    def setup(self):
        ...
        self.add_output(
            "constraints:propulsion:he_power_train:ACPMSM:" + pmsm_id + ":torque_rating",
            units="N*m",
            val=0.0,
            desc="Respected if <0",
        )
        self.declare_partials(
            of="constraints:propulsion:he_power_train:ACPMSM:" + pmsm_id + ":torque_rating",
            wrt=[
                "data:propulsion:he_power_train:ACPMSM:" + pmsm_id + ":torque_max",
                "data:propulsion:he_power_train:ACPMSM:" + pmsm_id + ":torque_rating",
            ],
    ...
    def compute(self, inputs, outputs, discrete_inputs=None, discrete_outputs=None):
        ...
        outputs["constraints:propulsion:he_power_train:ACPMSM:" + pmsm_id + ":torque_rating"] = (
            inputs["data:propulsion:he_power_train:ACPMSM:" + pmsm_id + ":torque_max"]
            - inputs["data:propulsion:he_power_train:ACPMSM:" + pmsm_id + ":torque_rating"]
        )
...
class ConstraintsRPMEnsure(om.ExplicitComponent):
    ...
    def setup(self):
        ...
        self.add_output(
            "constraints:propulsion:he_power_train:ACPMSM:" + pmsm_id + ":rpm_rating",
            units="min**-1",
            val=0.0,
            desc="Respected if <0",
        )
        self.declare_partials(
            of="constraints:propulsion:he_power_train:ACPMSM:" + pmsm_id + ":rpm_rating",
            wrt=[
                "data:propulsion:he_power_train:ACPMSM:" + pmsm_id + ":rpm_max",
                "data:propulsion:he_power_train:ACPMSM:" + pmsm_id + ":rpm_rating",
            ],
    ...
    def compute(self, inputs, outputs, discrete_inputs=None, discrete_outputs=None):
        ...
        outputs["constraints:propulsion:he_power_train:ACPMSM:" + pmsm_id + ":rpm_rating"] = (
            inputs["data:propulsion:he_power_train:ACPMSM:" + pmsm_id + ":rpm_max"]
            - inputs["data:propulsion:he_power_train:ACPMSM:" + pmsm_id + ":rpm_rating"]
        )
...
class ConstraintsVoltageEnsure(om.ExplicitComponent):
    ...
    def setup(self):
        ...
        self.add_output(
            name="constraints:propulsion:he_power_train:ACPMSM:" + pmsm_id + ":voltage_caliber",
            val=-0.0,
            units="V",
            desc="Respected if <0",
        )
        ...
        self.declare_partials(
            of="constraints:propulsion:he_power_train:ACPMSM:" + pmsm_id + ":voltage_caliber",
            wrt=[
                "data:propulsion:he_power_train:ACPMSM:" + pmsm_id + ":voltage_ac_max",
                "data:propulsion:he_power_train:ACPMSM:" + pmsm_id + ":voltage_caliber",
            ],
            method="exact",
        )
    ...
    def compute(self, inputs, outputs, discrete_inputs=None, discrete_outputs=None):
        ...
        outputs["constraints:propulsion:he_power_train:ACPMSM:" + pmsm_id + ":voltage_caliber"] = (
            inputs["data:propulsion:he_power_train:ACPMSM:" + pmsm_id + ":voltage_ac_max"]
            - inputs["data:propulsion:he_power_train:ACPMSM:" + pmsm_id + ":voltage_caliber"]
        )
    ...
    def compute_partials(self, inputs, partials, discrete_inputs=None):
        ...
        partials[
            "constraints:propulsion:he_power_train:ACPMSM:" + pmsm_id + ":voltage_caliber",
            "data:propulsion:he_power_train:ACPMSM:" + pmsm_id + ":voltage_ac_max",
        ] = 1.0
        partials[
            "constraints:propulsion:he_power_train:ACPMSM:" + pmsm_id + ":voltage_caliber",
