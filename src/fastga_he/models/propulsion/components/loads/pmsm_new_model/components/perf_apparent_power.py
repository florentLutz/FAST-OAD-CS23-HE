...
class PerformancesApparentPower(om.ExplicitComponent):
    ...
    def setup(self):
        ...
        self.add_input(
            "settings:propulsion:he_power_train:ACPMSM:" + pmsm_id + ":power_factor", val=1.0
        )
        ...
        self.declare_partials(
            of="*",
            wrt="settings:propulsion:he_power_train:ACPMSM:" + pmsm_id + ":power_factor",
            method="exact",
            rows=np.arange(number_of_points),
    ...
    def compute(self, inputs, outputs, discrete_inputs=None, discrete_outputs=None):
        ...
        outputs["apparent_power"] = (
            inputs["active_power"]
            / inputs["settings:propulsion:he_power_train:ACPMSM:" + pmsm_id + ":power_factor"]
        )
    ...
    def compute_partials(self, inputs, partials, discrete_inputs=None):
        ...
        partials[
            "apparent_power",
            "settings:propulsion:he_power_train:ACPMSM:" + pmsm_id + ":power_factor",
        ] = -(
            inputs["active_power"]
            / inputs["settings:propulsion:he_power_train:ACPMSM:" + pmsm_id + ":power_factor"]
            ** 2.0
