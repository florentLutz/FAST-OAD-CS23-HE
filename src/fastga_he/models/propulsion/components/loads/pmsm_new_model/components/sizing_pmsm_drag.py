...
class SizingPMSMDrag(om.ExplicitComponent):
    ...
    def setup(self):
        ...
        if position == "on_the_wing":
            ...
            self.add_input(
                name="data:propulsion:he_power_train:ACPMSM:" + pmsm_id + ":fairing:fineness",
                val=1.75,
        ...
        self.add_output(
            "data:propulsion:he_power_train:ACPMSM:" + pmsm_id + ":" + ls_tag + ":CD0",
            val=0.0,
        )
    ...
    def compute(self, inputs, outputs, discrete_inputs=None, discrete_outputs=None):
        ...
        if position == "on_the_wing":
            ...
            outputs["data:propulsion:he_power_train:ACPMSM:" + pmsm_id + ":" + ls_tag + ":CD0"] = (
                cd0
            )
