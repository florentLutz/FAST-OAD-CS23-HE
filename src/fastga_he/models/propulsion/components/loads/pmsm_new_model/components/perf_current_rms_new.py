...
class PerformancesCurrentRMS(om.ExplicitComponent):
    ...
    def setup(self):
        ...
        self.add_input(
            name="data:propulsion:he_power_train:ACPMSM:" + pmsm_id + ":torque_constant",
            val=np.nan,
            units="N*m/A",
        )
        ...
        self.declare_partials(
            of="*",
            wrt="data:propulsion:he_power_train:ACPMSM:" + pmsm_id + ":torque_constant",
            method="exact",
            rows=np.arange(number_of_points),
    ...
    def compute(self, inputs, outputs, discrete_inputs=None, discrete_outputs=None):
        ...
        k_t = inputs["data:propulsion:he_power_train:ACPMSM:" + pmsm_id + ":torque_constant"]
    ...
    def compute_partials(self, inputs, partials, discrete_inputs=None):
        ...
        partials[
            "ac_current_rms_in",
            "data:propulsion:he_power_train:ACPMSM:" + pmsm_id + ":torque_constant",
        ] = -torque / k_t**2.0
