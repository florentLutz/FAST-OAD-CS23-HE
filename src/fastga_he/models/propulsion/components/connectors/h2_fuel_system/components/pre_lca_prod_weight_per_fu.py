...
class PreLCAH2FuelSystemProdWeightPerFU(om.ExplicitComponent):
    def initialize(self):
    ...
    def setup(self):
        ...
        self.add_input(
            ...
            units="kg",
            val=np.nan,
            desc="Weight of the H2 fuel system",
        )
        self.add_input(
    ...
    def compute(self, inputs, outputs, discrete_inputs=None, discrete_outputs=None):
        ...
        outputs[
            "data:propulsion:he_power_train:H2_fuel_system:" + h2_fuel_system_id + ":mass_per_fu"
        ] = (
            inputs["data:propulsion:he_power_train:H2_fuel_system:" + h2_fuel_system_id + ":mass"]
