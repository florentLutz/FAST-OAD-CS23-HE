...
class SizingH2FuelSystemOverallCrossSectionDimension(om.ExplicitComponent):
    """
    Computation of the overall cross-section dimension of the hydrogen fuel system.
    """
