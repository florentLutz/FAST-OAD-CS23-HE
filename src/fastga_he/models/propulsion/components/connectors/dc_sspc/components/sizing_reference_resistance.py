...
class SizingDCSSPCResistances(om.ExplicitComponent):
    """
    ...
    def setup(self):
        ...
        self.declare_partials(
            ...
            wrt="data:propulsion:he_power_train:DC_SSPC:" + dc_sspc_id + ":scaling:resistance",
            method="exact",
        )
    ...
    def compute(self, inputs, outputs, discrete_inputs=None, discrete_outputs=None):
        ...
        outputs["data:propulsion:he_power_train:DC_SSPC:" + dc_sspc_id + ":igbt:resistance"] = (
            inputs["data:propulsion:he_power_train:DC_SSPC:" + dc_sspc_id + ":scaling:resistance"]
            * self.options["R_igbt_ref"]
        )

        outputs["data:propulsion:he_power_train:DC_SSPC:" + dc_sspc_id + ":diode:resistance"] = (
            inputs["data:propulsion:he_power_train:DC_SSPC:" + dc_sspc_id + ":scaling:resistance"]
