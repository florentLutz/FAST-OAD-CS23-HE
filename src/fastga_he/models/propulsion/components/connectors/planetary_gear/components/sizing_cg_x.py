...
class SizingPlanetaryGearCGX(om.ExplicitComponent):
    """
    ...
    def setup(self):
        ...
        if position == "inside_the_wing":
            ...
            self.add_input(
                ...
                + ":front_length_ratio",
                val=0.9,
                desc="Location of the planetary gear CG as a ratio of the aircraft front length",
            )
            ...
            self.add_input(
                ...
                + ":rear_length_ratio",
                val=0.1,
                desc="Location of the planetary gear CG as a ratio of the aircraft rear length",
            )

        self.add_output(
            "data:propulsion:he_power_train:planetary_gear:" + planetary_gear_id + ":CG:x",
            units="m",
            val=2.5,
            desc="X position of the planetary gear center of gravity",
        )
