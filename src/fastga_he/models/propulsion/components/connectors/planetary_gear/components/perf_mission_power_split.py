...
class PerformancesMissionPowerSplit(om.ExplicitComponent):
    """
    Component which takes the desired power split for the gear operation from the data and
    ...
    def compute(self, inputs, outputs, discrete_inputs=None, discrete_outputs=None):
        ...
        power_split = inputs[
            "data:propulsion:he_power_train:planetary_gear:" + planetary_gear_id + ":power_split"
        ]
