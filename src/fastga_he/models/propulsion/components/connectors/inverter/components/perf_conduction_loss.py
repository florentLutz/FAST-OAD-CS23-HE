...
class PerformancesConductionLosses(om.ExplicitComponent):
    ...
    def setup(self):
        ...
        self.declare_partials(
            ...
            wrt="data:propulsion:he_power_train:inverter:" + inverter_id + ":power_factor",
            method="exact",
    ...
    def compute_partials(self, inputs, partials, discrete_inputs=None):
        ...
        partials["conduction_losses_diode", "ac_current_rms_out_one_phase"] = v_d0 / (
            2.0 * np.pi
