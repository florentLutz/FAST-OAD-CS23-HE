...
@oad.RegisterSubmodel(
    SUBMODEL_INVERTER_JUNCTION_TEMPERATURE, SUBMODEL_INVERTER_JUNCTION_TEMPERATURE_FIXED
)
class PerformancesJunctionTemperatureMission(om.ExplicitComponent):
    """
    Component which takes the desired junction temperature for inverter operation from the data
    ...
    def setup(self):
        ...
        self.add_input(
            ...
            val=np.nan,
            units="degK",
            desc="Junction temperature of the inverter for the performances computation",
            shape_by_conn=True,
        )
