...
class SizingInverterResistances(om.ExplicitComponent):
    ...
    def setup(self):
        ...
        self.add_input(
            "settings:propulsion:he_power_train:inverter:" + inverter_id + ":igbt:k_resistance",
            val=1.0,
            units="unitless",
        )
        self.add_input(
            "settings:propulsion:he_power_train:inverter:" + inverter_id + ":diode:k_resistance",
            val=1.0,
            units="unitless",
        )
    ...
    def setup_partials(self):
        ...
        self.declare_partials(
            of="data:propulsion:he_power_train:inverter:" + inverter_id + ":igbt:resistance",
            wrt=[
                "data:propulsion:he_power_train:inverter:" + inverter_id + ":scaling:resistance",
                "settings:propulsion:he_power_train:inverter:" + inverter_id + ":igbt:k_resistance",
            ],
        ...
        self.declare_partials(
            of="data:propulsion:he_power_train:inverter:" + inverter_id + ":diode:resistance",
            wrt=[
                "data:propulsion:he_power_train:inverter:" + inverter_id + ":scaling:resistance",
