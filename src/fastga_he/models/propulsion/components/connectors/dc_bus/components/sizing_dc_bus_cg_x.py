...
class SizingDCBusCGX(om.ExplicitComponent):
    """
    ...
    def setup(self):
        ...
        if position == "inside_the_wing":
            ...
            self.add_input(
                ...
                val=0.9,
                desc="Location of the DC bus CG as a ratio of the aircraft front length",
            )
            ...
            self.add_input(
                name="data:propulsion:he_power_train:DC_bus:" + dc_bus_id + ":rear_length_ratio",
                val=0.1,
                desc="Location of the DC bus CG as a ratio of the aircraft rear length",
            )
    ...
    def compute(self, inputs, outputs, discrete_inputs=None, discrete_outputs=None):
        ...
        if position == "inside_the_wing":
            ...
            outputs["data:propulsion:he_power_train:DC_bus:" + dc_bus_id + ":CG:x"] = (
                ...
                * inputs[
                    "data:propulsion:he_power_train:DC_bus:" + dc_bus_id + ":rear_length_ratio"
                ]
            )
    ...
    def compute_partials(self, inputs, partials, discrete_inputs=None):
        ...
        if position == "inside_the_wing":
            ...
            ] = inputs["data:propulsion:he_power_train:DC_bus:" + dc_bus_id + ":rear_length_ratio"]
            partials[
                "data:propulsion:he_power_train:DC_bus:" + dc_bus_id + ":CG:x",
                "data:propulsion:he_power_train:DC_bus:" + dc_bus_id + ":rear_length_ratio",
            ] = inputs["data:geometry:fuselage:rear_length"]
