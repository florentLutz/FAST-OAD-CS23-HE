...
class SizingDCDCConverterCGX(om.ExplicitComponent):
    """
    ...
    def setup(self):
        ...
        if position == "inside_the_wing":
            ...
            self.add_input(
                ...
                + ":front_length_ratio",
                val=0.9,
                desc="Location of the DC/DC converter CG as a ratio of the aircraft front length",
            )
            ...
            self.add_input(
                ...
                + ":rear_length_ratio",
                val=0.1,
                desc="Location of the DC/DC converter CG as a ratio of the aircraft rear length",
            )

        self.add_output(
            "data:propulsion:he_power_train:DC_DC_converter:" + dc_dc_converter_id + ":CG:x",
            units="m",
            val=2.5,
            desc="X position of the DC/DC converter center of gravity",
        )
