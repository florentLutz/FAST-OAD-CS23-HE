...
class SizingDCDCConverterEnergyCoefficients(om.ExplicitComponent):
    """
    Computation of coefficients of the computation of commutation energy in diodes and IGBT.
    Reference for IGBT and diode is the SEMiX453GB12M7p from Semikron. Same as in the inverter
    computation.
    """
