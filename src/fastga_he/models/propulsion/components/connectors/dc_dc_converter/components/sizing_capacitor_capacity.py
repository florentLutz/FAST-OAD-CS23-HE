...
class SizingDCDCConverterCapacitorCapacity(om.ExplicitComponent):
    ...
    def compute_partials(self, inputs, partials, discrete_inputs=None):
        ...
        partials[
            ...
            -0.25
            * current_caliber
            / (voltage_ripple * voltage_caliber ** 2.0 * switching_frequency)
        )
        partials[
            "data:propulsion:he_power_train:DC_DC_converter:"
            + dc_dc_converter_id
            ...
            -0.25
            * current_caliber
            / (voltage_ripple ** 2.0 * voltage_caliber * switching_frequency)
        )
        partials[
            "data:propulsion:he_power_train:DC_DC_converter:"
            + dc_dc_converter_id
            ...
            -0.25
            * current_caliber
            / (voltage_ripple * voltage_caliber * switching_frequency ** 2.0)
        )
