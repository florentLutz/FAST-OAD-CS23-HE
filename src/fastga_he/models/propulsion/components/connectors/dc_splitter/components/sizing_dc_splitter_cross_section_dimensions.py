...
class SizingSplitterCrossSectionDimensions(om.ExplicitComponent):
    """
    Computation of the splitter bar cross section dimensions, based on a width to thickness ratio.
    """
