...
class SizingDCSplitterInsulationThickness(om.ExplicitComponent):
    """
    The thickness that separates the two planes of the splitter bar depends on the partial discharge
    ...
    def compute(self, inputs, outputs, discrete_inputs=None, discrete_outputs=None):
        ...
        t_v = inputs["settings:propulsion:he_power_train:DC_splitter:insulation:void_thickness"]
        alpha = inputs[
            "settings:propulsion:he_power_train:DC_splitter:insulation:breakdown_voltage"
        ]
        ...
        outputs[
            "data:propulsion:he_power_train:DC_splitter:" + dc_splitter_id + ":insulation:thickness"
        ] = t_i
