...
class SizingDCSplitterDrag(om.ExplicitComponent):
    """
    Class that computes the drag coefficient of the DC splitter based on its position. Will be 0.0
    all the time as we will make the assumption that the DC splitter is "inside" the fuselage or in
    ...
    def setup(self):
        ...
        self.add_output(
            "data:propulsion:he_power_train:DC_splitter:" + dc_splitter_id + ":" + ls_tag + ":CD0",
            val=0.0,
        )
