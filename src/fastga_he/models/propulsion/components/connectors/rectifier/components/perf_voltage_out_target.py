...
class PerformancesVoltageOutTargetMission(om.ExplicitComponent):
    """
    Component which takes the desired voltage output target for rectifier operation from the data
    ...
    def setup(self):
        ...
        self.add_input(
            ...
            val=np.nan,
            units="V",
            desc="Target output voltage of the rectifier for the points",
            shape_by_conn=True,
        )
