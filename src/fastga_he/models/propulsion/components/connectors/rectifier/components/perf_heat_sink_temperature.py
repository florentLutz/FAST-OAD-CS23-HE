...
class PerformancesHeatSinkTemperatureMission(om.ExplicitComponent):
    """
    Component which takes the desired heat sink temperature for rectifier operation from the data
    ...
    def setup(self):
        ...
        self.add_input(
            ...
            val=np.nan,
            units="degK",
            desc="Heat sink temperature of the rectifier for the points",
            shape_by_conn=True,
        )
