...
class SizingRectifierEnergyCoefficients(om.ExplicitComponent):
    ...
    def setup(self):
        ...
        self.add_input(
            "data:propulsion:he_power_train:rectifier:" + rectifier_id + ":scaling:a", val=np.nan
        )
        self.add_input(
            "data:propulsion:he_power_train:rectifier:" + rectifier_id + ":scaling:c", val=np.nan
        )
        ...
        self.declare_partials(
            ...
            wrt="data:propulsion:he_power_train:rectifier:" + rectifier_id + ":scaling:a",
            method="exact",
        )
        self.declare_partials(
            of=[
        ...
        self.declare_partials(
            ...
            wrt="data:propulsion:he_power_train:rectifier:" + rectifier_id + ":scaling:c",
            method="exact",
        )
    ...
    def compute(self, inputs, outputs, discrete_inputs=None, discrete_outputs=None):
        ...
        c_star = inputs["data:propulsion:he_power_train:rectifier:" + rectifier_id + ":scaling:c"]

        outputs["data:propulsion:he_power_train:rectifier:" + rectifier_id + ":energy_on:a"] = (
            a_star * self.options["a_on_ref"]
        )
        outputs["data:propulsion:he_power_train:rectifier:" + rectifier_id + ":energy_rr:a"] = (
            a_star * self.options["a_rr_ref"]
        )
        outputs["data:propulsion:he_power_train:rectifier:" + rectifier_id + ":energy_off:a"] = (
        ...
        outputs["data:propulsion:he_power_train:rectifier:" + rectifier_id + ":energy_rr:c"] = (
            c_star * self.options["c_rr_ref"]
        )
        outputs["data:propulsion:he_power_train:rectifier:" + rectifier_id + ":energy_off:c"] = (
