...
class SizingGearboxCGX(om.ExplicitComponent):
    """
    Class that computes the CG of the gearbox based on its position. Will be based on simple
    ...
    def setup(self):
        ...
        if position == "inside_the_wing":
            ...
            self.add_input(
                ...
                val=0.9,
                desc="Location of the gearbox CG as a ratio of the aircraft front length",
            )
            ...
            self.add_input(
                name="data:propulsion:he_power_train:gearbox:" + gearbox_id + ":rear_length_ratio",
                val=0.1,
                desc="Location of the gearbox CG as a ratio of the aircraft rear length",
            )
        ...
        self.add_output(
            ...
            units="m",
            val=2.5,
            desc="X position of the gearbox center of gravity",
        )
    ...
    def compute(self, inputs, outputs, discrete_inputs=None, discrete_outputs=None):
        ...
        if position == "inside_the_wing":
            ...
            outputs["data:propulsion:he_power_train:gearbox:" + gearbox_id + ":CG:x"] = (
                ...
                * inputs[
                    "data:propulsion:he_power_train:gearbox:" + gearbox_id + ":rear_length_ratio"
                ]
            )
