...
class SizingGearboxCGY(om.ExplicitComponent):
    """
    ...
    def setup(self):
        ...
        self.add_output(
            ...
            units="m",
            val=0.0,
            desc="Y position of the gearbox center of gravity",
        )
        ...
        if position == "inside_the_wing":
            ...
            self.add_input(
                ...
                val=np.nan,
                desc="Y position of the gearbox center of gravity as a ratio of the wing half-span",
            )
