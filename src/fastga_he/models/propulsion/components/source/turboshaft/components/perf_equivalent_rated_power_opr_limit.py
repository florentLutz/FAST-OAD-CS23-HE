...
class PerformancesEquivalentRatedPowerOPRLimit(om.ExplicitComponent):
    """
    Computation of the rated power equivalent to te thermodynamic power required if the OPR was a
