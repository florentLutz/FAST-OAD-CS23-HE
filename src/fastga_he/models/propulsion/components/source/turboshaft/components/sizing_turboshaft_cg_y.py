...
class SizingTurboshaftCGY(om.ExplicitComponent):
    """
    Class that computes the Y-CG of the turboshaft based on its position. Will be based on simple
    ...
    def setup(self):
        ...
        self.add_output(
            ...
            units="m",
            val=0.0,
            desc="Y position of the turboshaft center of gravity",
        )
        ...
        if position == "on_the_wing":
            self.add_input(
                ...
                val=np.nan,
                desc="Y position of the turboshaft center of gravity as a ratio of the wing half-span",
            )
    ...
    def compute_partials(self, inputs, partials, discrete_inputs=None):
        ...
        if position == "on_the_wing":
            partials[
                ...
                inputs["data:propulsion:he_power_train:turboshaft:" + turboshaft_id + ":CG:y_ratio"]
                / 2.0
            )
            partials[
                "data:propulsion:he_power_train:turboshaft:" + turboshaft_id + ":CG:y",
