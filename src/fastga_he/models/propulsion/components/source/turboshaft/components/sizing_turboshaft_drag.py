...
class SizingTurboshaftDrag(om.ExplicitComponent):
    """
    Additional drag coefficient due to the installation of the turboshaft depending on the location,
    inside the nose, it will be computed as not contributing. Based on the formula from
    :cite:`gudmundsson:2013` for the form drag and and :cite:`roskampart6:1985` for the
    interference drag.
    """
