...
SUBMODEL_CONSTRAINTS_PEMFC_BOP_EFFECTIVE_AREA = (
    "submodel.propulsion.constraints.pemfc_bop.effective_area"
)
SUBMODEL_CONSTRAINTS_PEMFC_BOP_POWER = "submodel.propulsion.constraints.pemfc_bop.power"
...
DEFAULT_AIR_CONSUMPTION = 160.0  # [kg]
