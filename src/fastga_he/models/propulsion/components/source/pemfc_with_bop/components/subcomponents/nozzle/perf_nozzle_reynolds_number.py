...
class PerformancesNozzleReynoldsNumber(om.ExplicitComponent):
    """
    Computation of the reynolds number in the nozzle.
    """
    ...
    def compute(self, inputs, outputs, discrete_inputs=None, discrete_outputs=None):
        ...
        air_dynamic_viscosity = inputs["nozzle_air_dynamic_viscosity"]
    ...
    def compute_partials(self, inputs, partials, discrete_inputs=None):
        ...
        partials["air_reynolds_number", "nozzle_air_density"] = (
            average_air_speed * entry_hydraulic_diameter / air_dynamic_viscosity
        )

        partials["air_reynolds_number", "nozzle_air_dynamic_viscosity"] = (
