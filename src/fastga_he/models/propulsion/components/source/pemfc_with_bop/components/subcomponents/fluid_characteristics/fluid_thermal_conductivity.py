...
from .constant import fluid_name_dict, fluid_thermal_conductivity_dict


class FluidThermalConductivity(om.Group):
    """
    ...
    def setup(self):
        ...
        self.add_subsystem(
            ...
            _ThermalConductivity(number_of_points=number_of_points, fluid=fluid),
            promotes=["fluid_thermal_conductivity"],
        )

        self.connect("property_check.temperature", "thermal_conductivity.temperature")
        self.connect("property_check.pressure", "thermal_conductivity.pressure")
...
class _ThermalConductivity(om.ExplicitComponent):
    """
    Fluid specific heat capacity calculation for heat transfer models.
    """
    ...
    def setup(self):
        ...
        self.add_output(
            ...
            val=fluid_thermal_conductivity_dict[fluid],
            units="W/m/K",
