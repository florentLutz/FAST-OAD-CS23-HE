...
class ConstraintsPEMFCStack(om.Group):
    ...
    def setup(self):
        ...
        self.add_subsystem(
            name="constraints_pemfc_bop_effective_area",
            subsys=oad.RegisterSubmodel.get_submodel(
                SUBMODEL_CONSTRAINTS_PEMFC_BOP_EFFECTIVE_AREA, options=options_constraints
            ),
            promotes=["*"],
        )
        self.add_subsystem(
            name="constraints_pemfc_bop_power",
            subsys=oad.RegisterSubmodel.get_submodel(
                SUBMODEL_CONSTRAINTS_PEMFC_BOP_POWER,
                options={"pemfc_stack_bop_id": self.options["pemfc_stack_bop_id"]},
            ),
            promotes=["*"],
        )
