...
class SizingPipe(om.Group):
    ...
    def setup(self):
        ...
        self.add_subsystem(
            "pipe_inner_radius",
            SizingPipeInnerRadius(pemfc_stack_bop_id=pemfc_stack_bop_id),
            promotes=["data:*"],
        )
        self.add_subsystem(
            "pipe_wall_thickness",
            SizingPipeWallThickness(pemfc_stack_bop_id=pemfc_stack_bop_id),
            promotes=["data:*"],
        )
        self.add_subsystem(
            "pipe_total_weight",
            SizingPipeWeight(pemfc_stack_bop_id=pemfc_stack_bop_id),
            promotes=["data:*"],
        )
