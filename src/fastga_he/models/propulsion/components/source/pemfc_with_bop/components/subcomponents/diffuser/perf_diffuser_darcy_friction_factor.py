...
class PerformancesDiffuserDarcyFrictionFactor(om.ExplicitComponent):
    """
    Computation of the Darcy flow friction factor in the diffuser.
    """
    ...
    def compute(self, inputs, outputs, discrete_inputs=None, discrete_outputs=None):
        ...
        if reynolds_number < 3000.0:
            outputs["diffuser_darcy_friction_factor"] = 64.0 / reynolds_number
        else:
            # Haaland's equation
            outputs["diffuser_darcy_friction_factor"] = (
