...
@oad.RegisterSubmodel(
    SUBMODEL_CONSTRAINTS_PEMFC_BOP_EFFECTIVE_AREA,
    "fastga_he.submodel.propulsion.constraints.pemfc_stack_bop.effective_area.ensure",
)
class ConstraintsPEMFCStackBOPEffectiveAreaEnsure(om.ExplicitComponent):
    """
    ...
    def setup(self):
        ...
        self.add_output(
            "constraints:propulsion:he_power_train:PEMFC_stack_bop:"
            + pemfc_stack_bop_id
            + ":effective_area",
            units="cm**2",
            val=-0.0,
        ...
        self.declare_partials(
            of="constraints:propulsion:he_power_train:PEMFC_stack_bop:"
            + pemfc_stack_bop_id
            + ":effective_area",
...
@oad.RegisterSubmodel(
    SUBMODEL_CONSTRAINTS_PEMFC_BOP_POWER,
    "fastga_he.submodel.propulsion.constraints.pemfc_stack_bop.power.ensure",
)
class ConstraintsPEMFCStackBOPPowerEnsure(om.ExplicitComponent):
    """
