...
class PerformancesPEMFCStackBOPPolarizationCurveEmpirical(om.ExplicitComponent):
    """
...
class PerformancesPEMFCStackBOPPolarizationCurveAnalytical(om.ExplicitComponent):
    """
