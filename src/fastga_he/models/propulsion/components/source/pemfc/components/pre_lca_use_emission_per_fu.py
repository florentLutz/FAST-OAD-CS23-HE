...
class PreLCAPEMFCStackUseEmissionPerFU(om.ExplicitComponent):
    """
    ...
    def setup(self):
        ...
        for specie in SPECIES_LIST:
            ...
            operation_output_name = (
                "data:LCA:operation:he_power_train:PEMFC_stack:"
                + pemfc_stack_id
                + ":"
                + specie
                + "_per_fu"
            ...
            manufacturing_output_name = (
                "data:LCA:manufacturing:he_power_train:PEMFC_stack:"
                + pemfc_stack_id
                + ":"
                + specie
                + "_per_fu"
            ...
            distribution_output_name = (
                "data:LCA:distribution:he_power_train:PEMFC_stack:"
                + pemfc_stack_id
                + ":"
                + specie
                + "_per_fu"
