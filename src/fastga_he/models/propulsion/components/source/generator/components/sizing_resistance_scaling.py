...
class SizingGeneratorPhaseResistanceScaling(om.ExplicitComponent):
    """
    Computation of scaling factor for the phase resistance of cylindrical generator.
    ...
    def initialize(self):
        ...
        self.options.declare(
            "max_voltage_ref",
            default=800.0,
            desc="Max voltage of the reference generator in [V]",
        )
