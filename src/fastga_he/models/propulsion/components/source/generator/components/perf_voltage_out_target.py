...
class PerformancesVoltageOutTargetMission(om.ExplicitComponent):
    """
    Component which takes the desired voltage output target for the generator operation from the
    data and gives it the right format for the mission. It was deemed best to put it this way
    rather than the original way to simplify the construction of the power train file.
    ...
    def setup(self):
        ...
        self.add_input(
            ...
            val=np.nan,
            units="V",
            desc="Target output voltage of the generator for the points",
            shape_by_conn=True,
        )
