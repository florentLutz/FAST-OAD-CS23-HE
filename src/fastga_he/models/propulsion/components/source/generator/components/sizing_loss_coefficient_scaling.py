...
class SizingGeneratorLossCoefficientScaling(om.ExplicitComponent):
    """
    ...
    def setup(self):
        ...
        self.declare_partials(
            of="data:propulsion:he_power_train:generator:" + generator_id + ":scaling:alpha",
            wrt="*",
            method="exact",
        )
        self.declare_partials(
            of="data:propulsion:he_power_train:generator:" + generator_id + ":scaling:beta",
            wrt="*",
            method="exact",
        )
        self.declare_partials(
            of="data:propulsion:he_power_train:generator:" + generator_id + ":scaling:gamma",
            wrt="*",
            method="exact",
        )
