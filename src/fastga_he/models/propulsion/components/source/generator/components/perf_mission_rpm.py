...
class PerformancesRPMMission(om.ExplicitComponent):
    ...
    def setup(self):
        ...
        self.add_input(
            name="data:propulsion:he_power_train:generator:" + generator_id + ":rpm_mission",
            val=np.nan,
            units="min**-1",
    ...
    def compute(self, inputs, outputs, discrete_inputs=None, discrete_outputs=None):
        ...
        rpm_mission = inputs[
            "data:propulsion:he_power_train:generator:" + generator_id + ":rpm_mission"
        ]
    ...
    def compute_partials(self, inputs, partials, discrete_inputs=None):
        ...
        if len(rpm_mission) == 1:
            partials[
                "rpm", "data:propulsion:he_power_train:generator:" + generator_id + ":rpm_mission"
