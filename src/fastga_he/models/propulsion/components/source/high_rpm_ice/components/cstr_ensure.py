...
@oad.RegisterSubmodel(
    ...
    "fastga_he.submodel.propulsion.constraints.high_rpm_ice.sea_level_power.ensure",
)
class ConstraintsSeaLevelPowerEnsure(om.ExplicitComponent):
    ...
    def setup(self):
        ...
        self.add_output(
            "constraints:propulsion:he_power_train:high_rpm_ICE:"
            + high_rpm_ice_id
            + ":power_rating_SL",
            units="kW",
            val=-0.0,
        ...
        self.declare_partials(
            of="constraints:propulsion:he_power_train:high_rpm_ICE:"
            + high_rpm_ice_id
            + ":power_rating_SL",
