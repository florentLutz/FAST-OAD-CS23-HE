...
class SizingTurboGeneratorCGY(om.ExplicitComponent):
    """
    Class that computes the Y-CG of the turbo generator based on its position. Will be based on
    ...
    def setup(self):
        ...
        self.add_output(
            ...
            units="m",
            val=0.0,
            desc="Y position of the turbo generator center of gravity",
        )
