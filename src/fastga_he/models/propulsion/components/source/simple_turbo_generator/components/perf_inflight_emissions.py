...
from .perf_inflight_emissions_sum import PerformancesTurboGeneratorInFlightEmissionsSum


class PerformancesTurboGeneratorInFlightEmissions(om.Group):
    """
    ...
    def setup(self):
        ...
        self.add_subsystem(
            name="emissions_sum",
            subsys=PerformancesTurboGeneratorInFlightEmissionsSum(
