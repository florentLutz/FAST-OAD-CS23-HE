...
class PreLCATurboGeneratorProdWeightPerFU(om.ExplicitComponent):
    """
    ...
    turbogenerator, the value is taken from :cite:`thonemann:2024` for short term technologies.
    """
    ...
    def compute(self, inputs, outputs, discrete_inputs=None, discrete_outputs=None):
        ...
        outputs[
            "data:propulsion:he_power_train:turbo_generator:" + turbo_generator_id + ":mass_per_fu"
        ] = (
            inputs["data:propulsion:he_power_train:turbo_generator:" + turbo_generator_id + ":mass"]
    ...
    def compute_partials(self, inputs, partials, discrete_inputs=None):
        ...
        partials[
            ...
            inputs["data:TLAR:aircraft_lifespan"]
            / inputs[
                "data:propulsion:he_power_train:turbo_generator:" + turbo_generator_id + ":lifespan"
            ]
        )
        partials[
            "data:propulsion:he_power_train:turbo_generator:" + turbo_generator_id + ":mass_per_fu",
