...
class PerformancesCurrentRMS3Phases(om.ExplicitComponent):
    """
    Computation of the current in all 3 phases of the turbo generator based on the current in one
    phase.
    """
    ...
    def setup(self):
        ...
        self.add_input(
            ...
            units="A",
            desc="Current at the output side in one phase of the turbo generator",
        )
