...
class SizingPropellerSweep(om.ExplicitComponent):
    def initialize(self):
    ...
    def setup(self):
        ...
        self.add_input(
            "data:propulsion:he_power_train:propeller:" + propeller_id + ":sweep_vect",
            val=np.nan,
            units="deg",
            shape_by_conn=True,
        )
        ...
        self.add_output(
            name="data:propulsion:he_power_train:propeller:" + propeller_id + ":elements_sweep",
            shape=elements_number,
            units="deg",
        )
    ...
    def compute(self, inputs, outputs, discrete_inputs=None, discrete_outputs=None):
        ...
        sweep = np.interp(
            ...
            inputs["data:propulsion:he_power_train:propeller:" + propeller_id + ":sweep_vect"],
        )
