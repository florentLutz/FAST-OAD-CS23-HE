...
class SizingPropellerTwist(om.ExplicitComponent):
    def initialize(self):
    ...
    def setup(self):
        ...
        self.add_input(
            "data:propulsion:he_power_train:propeller:" + propeller_id + ":twist_vect",
            val=np.nan,
            units="deg",
            shape_by_conn=True,
        )
        ...
        self.add_output(
            name="data:propulsion:he_power_train:propeller:" + propeller_id + ":elements_twist",
            shape=elements_number,
            units="deg",
        )
    ...
    def compute(self, inputs, outputs, discrete_inputs=None, discrete_outputs=None):
        ...
        twist = np.interp(
            ...
            inputs["data:propulsion:he_power_train:propeller:" + propeller_id + ":twist_vect"],
        )
