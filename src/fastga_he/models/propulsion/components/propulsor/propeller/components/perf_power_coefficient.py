...
class PerformancesPowerCoefficient(om.ExplicitComponent):
    ...
    def compute_partials(self, inputs, partials, discrete_inputs=None):
        ...
        d_log_pi1_d_log_pi4 = (
            ...
            + 2.0 * 0.00430 * np.log10(j) * np.log10(re_d) * np.log10(j)
        ...
        d_log_pi1_d_log_pi5 = (
            ...
            + 0.00119 * np.log10(re_d) ** 2.0 * np.log10(activity_factor)
            + 0.08015 * np.log10(ct) ** 2.0 * np.log10(activity_factor)
        ...
        d_log_pi1_d_log_pi7 = (
            ...
            + 2.0 * 0.04562 * np.log10(solidity) * np.log10(activity_factor) * np.log10(solidity)
        ...
        d_log_pi1_d_log_pi8 = (
            ...
            + 2.0 * 0.00206 * np.log10(ct) ** 2.0 * np.log10(twist_blade)
        )
