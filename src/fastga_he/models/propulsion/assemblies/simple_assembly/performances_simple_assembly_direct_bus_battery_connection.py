...
class PerformancesAssemblyDirectBusBatteryConnection(om.Group):
    ...
    def setup(self):
        ...
        # DC BUS 2 TO BATTERY
        self.connect("dc_bus_2.dc_voltage", "battery_pack_1.voltage_out")
        self.connect("battery_pack_1.dc_current_out", "dc_bus_2.dc_current_in_1")
