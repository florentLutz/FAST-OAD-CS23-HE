...
DELTA_CD_FROM_PT_FILE = "fastga_he.submodel.propulsion.delta_cd.from_pt_file"
oad.RegisterSubmodel.active_models[SUBMODEL_POWER_TRAIN_DELTA_CD] = DELTA_CD_FROM_PT_FILE


@oad.RegisterSubmodel(SUBMODEL_POWER_TRAIN_DELTA_CD, DELTA_CD_FROM_PT_FILE)
