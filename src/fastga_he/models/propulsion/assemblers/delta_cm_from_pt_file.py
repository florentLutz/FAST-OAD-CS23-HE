...
DELTA_CM_FROM_PT_FILE = "fastga_he.submodel.propulsion.delta_cm.from_pt_file"
oad.RegisterSubmodel.active_models[SUBMODEL_POWER_TRAIN_DELTA_CM] = DELTA_CM_FROM_PT_FILE


@oad.RegisterSubmodel(SUBMODEL_POWER_TRAIN_DELTA_CM, DELTA_CM_FROM_PT_FILE)
