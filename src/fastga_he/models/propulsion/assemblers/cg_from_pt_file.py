...
CG_FROM_PT = "fastga_he.submodel.propulsion.cg.from_pt_file"
oad.RegisterSubmodel.active_models[SUBMODEL_POWER_TRAIN_CG] = CG_FROM_PT


@oad.RegisterSubmodel(SUBMODEL_POWER_TRAIN_CG, CG_FROM_PT)
