...
from fastga.models.loops.constants import SUBMODEL_WING_AREA_GEOM_LOOP, SUBMODEL_WING_AREA_GEOM_CONS
...
@oad.RegisterSubmodel(
    SUBMODEL_WING_AREA_GEOM_LOOP, "fastga_he.submodel.loop.wing_area.update.geom.advanced"
)
...
@oad.RegisterSubmodel(
    SUBMODEL_WING_AREA_GEOM_CONS, "fastga_he.submodel.loop.wing_area.constraint.geom.advanced"
)
