...
oad.RegisterSubmodel.active_models[SUBMODEL_LOADCASE_GROUND_X] = (
    "fastga.submodel.weight.cg.loadcase.ground.legacy"
)
...
@oad.RegisterSubmodel(
    SUBMODEL_LOADCASE_GROUND_X, "fastga_he.submodel.weight.cg.loadcase.ground.simple"
)
class ComputeGroundCGCase(om.ExplicitComponent):
    ...
    def setup(self):
        ...
        self.add_output("data:weight:aircraft:CG:ground_condition:max:MAC_position", val=0.40)
        self.add_output("data:weight:aircraft:CG:ground_condition:min:MAC_position", val=0.15)

        self.declare_partials(
            of="data:weight:aircraft:CG:ground_condition:max:MAC_position",
            wrt=[
                "data:geometry:wing:MAC:length",
                "data:geometry:wing:MAC:at25percent:x",
                "data:weight:aircraft_empty:CG:x",
        ...
        self.declare_partials(
            of="data:weight:aircraft:CG:ground_condition:min:MAC_position",
            wrt=[
                "data:geometry:wing:MAC:length",
                "data:geometry:wing:MAC:at25percent:x",
                "data:weight:aircraft_empty:CG:x",
    ...
    def compute(self, inputs, outputs, discrete_inputs=None, discrete_outputs=None):
        ...
        outputs["data:weight:aircraft:CG:ground_condition:min:MAC_position"] = (
            cg_aircraft_empty_mac - fwd_limit
        )
        outputs["data:weight:aircraft:CG:ground_condition:max:MAC_position"] = (
            cg_aircraft_empty_mac + aft_limit
        )
