...
class LCCFlightTestCost(om.ExplicitComponent):
    ...
    def setup(self):
        ...
        self.add_output(
            "data:cost:airframe:flight_test_cost_per_unit",
            val=2.0e5,
            units="USD",
    ...
    def compute(self, inputs, outputs, discrete_inputs=None, discrete_outputs=None):
        outputs["data:cost:airframe:flight_test_cost_per_unit"] = (
            0.009646
    ...
    def compute_partials(self, inputs, partials, discrete_inputs=None):
        ...
        partials["data:cost:airframe:flight_test_cost_per_unit", "data:weight:airframe:mass"] = (
            0.01118936
            * m_airframe**0.16
            * v_cruise**1.3718
            * num_prototype**1.281
        ...
        partials["data:cost:airframe:flight_test_cost_per_unit", "data:TLAR:v_cruise"] = (
            0.0132323828
            * m_airframe**1.16
            * v_cruise**0.3718
            * num_prototype**1.281
        ...
        partials["data:cost:airframe:flight_test_cost_per_unit", "data:cost:cpi_2012"] = (
