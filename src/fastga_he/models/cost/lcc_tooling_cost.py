...
class LCCToolingCost(om.ExplicitComponent):
    ...
    def setup(self):
        ...
        self.add_output(
            "data:cost:airframe:tooling_cost_per_unit",
            val=2.0e5,
            units="USD",
    ...
    def compute(self, inputs, outputs, discrete_inputs=None, discrete_outputs=None):
        outputs["data:cost:airframe:tooling_cost_per_unit"] = (
            2.0969
            * inputs["data:cost:airframe:tooling_man_hours"]
            * inputs["data:cost:airframe:tooling_cost_per_hour"]
            * inputs["data:cost:cpi_2012"]
        )

    def compute_partials(self, inputs, partials, discrete_inputs=None):
        mh_tooling = inputs["data:cost:airframe:tooling_man_hours"]
        cost_rate_tooling = inputs["data:cost:airframe:tooling_cost_per_hour"]
        ...
        partials["data:cost:airframe:tooling_cost_per_unit", "data:cost:cpi_2012"] = (
