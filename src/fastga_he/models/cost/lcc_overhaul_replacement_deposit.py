...
class LCCOverhaulReplacementDeposit(om.ExplicitComponent):
    """
    Computation of the annual deposit cost for future overhaul and replacements.
    """
    ...
    def setup(self):
        ...
        self.add_output("data:cost:operation:annual_overhaul_deposit", units="USD/yr", val=0.0)
    ...
    def compute(self, inputs, outputs, discrete_inputs=None, discrete_outputs=None):
        outputs["data:cost:operation:annual_overhaul_deposit"] = np.sum(inputs.values())
