...
class LCCAnnualCrewCost(om.ExplicitComponent):
    ...
    def setup(self):
        ...
        self.declare_partials("data:cost:operation:annual_crew_cost", "data:cost:operation:number_of_pilot", val=113556.7)
        self.declare_partials("data:cost:operation:annual_crew_cost", "data:cost:operation:number_of_cabin_crew", val=25200.0)
