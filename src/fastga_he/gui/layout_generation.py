...
class HierarchicalLayout:
    ...
    def _resolve_crossings_with_tutte(self, layer_spacing=100, node_spacing=100):
        """
        ...
        :param node_spacing: Spacing between nodes in a layer
    ...
    def compute(self, layer_spacing=100, node_spacing=100):
        ...
        if self.sorting:
            self._resolve_crossings_with_tutte(layer_spacing, node_spacing)
