...
can be integrated to the analysis by adding the corresponding `id` to the `configuration file <https://fast-oad.readthedocs.io/en/stable/documentation/usage.html#problem-definition>`_. The `id` for the LCC module is:
