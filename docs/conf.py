#  This file is part of FAST-OAD-CS23-HE : A framework for rapid Overall Aircraft Design of hybrid
...
def run_apidoc(_):
    ...
    module = os.path.join(cur_dir, "..", "src", "fastga_he")
    apidoc.main(
        [
            "-d",
            "1",
...
intersphinx_mapping = {
    ...
    "openmdao": ("https://openmdao.org/newdocs/versions/latest/main.html", None),
    "fast_oad": ("https://fast-oad.readthedocs.io/en/latest/", None),
}
