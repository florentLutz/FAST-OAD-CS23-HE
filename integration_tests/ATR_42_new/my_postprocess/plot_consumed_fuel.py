...
plt.plot(
    x1,
    colonna1,
    label="Turboshaft specific Fuel Consumption [kg/kW/h], full thermal",
    color="tab:blue",
)
plt.plot(
    x2, colonna2, label="Turboshaft specific Fuel Consumption [kg/kW/h], hybrid", color="tab:orange"
)
plt.xlabel("Timestep")
plt.ylabel("Valore")
plt.title("Confronto tra efficienza dell’elica e consumo del turboshaft")
...
plt.plot(
    x1,
    colonna1,
    label="Turboshaft turboshaft_1 power_required [kW], full thermal",
    color="tab:blue",
)
plt.plot(
    x2, colonna2, label="Turboshaft turboshaft_1 power_required [kW], hybrid", color="tab:orange"
)
plt.xlabel("Timestep")
plt.ylabel("Valore")
plt.title("Confronto tra efficienza dell’elica e consumo del turboshaft")
