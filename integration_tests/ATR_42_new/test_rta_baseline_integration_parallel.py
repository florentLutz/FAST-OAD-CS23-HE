...
CONFIGURATION_FILE = "atr42_retrofit_parallel.yml"
MISSION_FILE = "sizing_mission_R.yml"
SOURCE_FILE = "retrofit_ATR42_parallel_input.xml"
...
def test_sizing_atr_42_turboshaft():
    ...
    problem.set_val("data:weight:aircraft:MTOW", units="kg", val=33000.0)
    problem.set_val("data:weight:aircraft:OWE", units="kg", val=15000.0)
    problem.set_val("data:weight:aircraft:MZFW", units="kg", val=16000.0)
    problem.set_val("data:weight:aircraft:MLW", units="kg", val=17000.0)
